  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Esse endereço não existe no AXIS.</p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AXIS — Recarga elétrica circular" },
      {
        name: "description",
        content: "AXIS conecta motoristas a carregadores HCA G2 em comércios e dá controle total ao lojista.",
      },
